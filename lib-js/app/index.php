            ...
            new HTML.Tabs('idBlockTAbs', 'nav')
                ...
                .addTab(
                    ...
                    new HTML.Fields(4, null)
                        .setSkin('success')
                        .addInput('valuesss', 'Label-1', null, 'star', true)
                        .addInput('value', 'Label-2', null, 'minus')
                        .addInput('value', 'Label-1', null, 'plus')
                        .addInput('value', 'Label-1', null)
                        .setSkin('error')
                        .addInput('value')
                        .addInput('value')
                        .addInput('value', null, null, 'plus')
                        .setSkin(null)
                        .addInput('value')
                        .addInput('value')
                        .addInput('value')
