    ...
    <script type="text/javascript">
        //jQuery(document).ready(function() {
            new HTML.Tabs('idBlockTAbs', 'nav')
                ...
                .addTab(
                    'Fields',
                    new HTML.Fields(4, null)
                        .setSkin('success')
                        .addInput('valuesss', null, 'star', true)
                        .addInput('value', null, 'minus')
                        .addInput('value', null, 'plus')
                        .addInput('value', null)
                        .setSkin('error')
                        .addInput('value', null)
                        .addInput('value', null)
                    ...
                    new HTML.Fields(4, 'htmlclass-field', null)
                        .setPlaceholder()
                        .setMargin()
                        .setLineLabel()
                        .addInputLabel('value', 'label', null, 'star')
                        .addInputLabel('value', 'label')
                        .addInputLabel(null, 'label', null, 'star', true)
                        .addInputLabel(null, 'label')
                        .addInputLabel('value', 'label', null, 'plus')
                        .addInputLabel('value', 'label')
                        .addInputLabel(null, 'label')
                        .addInputLabel(null, 'label')
                        .addInputLabel(null, 'label', null, 'minus')
                        .addInputLabel('value', 'label')
                        .addInputLabel('value', 'label')
                        .addInputLabel(null, 'label')
                        .toHtml()
                    ...
                    new HTML.Fields(2)
                        ...
                        .addInputMarker(null, '@', '#', null, true)
                        .addInputMarker('text', '@', '#')
                        .addInputMarker(null, '@', '#')
                        .addInputMarker('text', '@', '#')
                        .addInputMarker(null, '@', '#', null)
                        .addInputMarker(null, '@', '#')
                        .addInputMarker('text', '@', '#')
                        .addInputMarker(null, '@', '#')
                        .addInputMarker('text', '@', '#', null)
                        .addInputMarker(null, '@', '#')
                        .addInputHidden('=================', '===================')
                        .addInputHidden('=================', '===================')
                        .addInputHidden('=================', '===================')
                    ...
                    new HTML.Fields(4)
                        ...
                        .setLineLabel()
                        .setSkin('muted')
                        .addInputRead('label', 'value text - 1', 'name-1')
                        .addInputRead('label', 'value text - 2', 'name-2')
                        .addInputRead('label', 'value text - 3', 'name-3')
                        .addInputRead('label', 'value text - 4', 'name-4')
                        .setSkin('success')
                        .addInputRead('label', 'value text - 5', 'name-5')
                        .addInputRead('label', 'value text - 6', 'name-6')
                        .addInputRead('label', 'value text - 6', 'name-6')
                        .addInputRead('label', 'value text - 3', 'name-3')
                        .setSkin('primary')
                        .addInputRead('label', 'value text - 4', 'name-4')
